 ...
 This will deploy two artifacts, target/proj.artifact.war and
 default-ds.xml.
 ...
 - http://localhost:8080/proj.artifact/
 ...
 Now you can either deploy the target/proj.artifact.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/proj.artifact.war

 To undeploy the application, run:

  ./asadmin undeploy proj.artifact
